...
//PULSE
int us1pulseline=15,us2pulseline=15,us3pulseline=15,us4pulseline=15;
//OCUPULSE
int us1ocupulseline=15,us2ocupulseline=15,us3ocupulseline=15,us4ocupulseline=15;
//OCUBURST
int us1ocuburstline=170,us2ocuburstline=170,us3ocuburstline=170,us4ocuburstline=170;
//SINGLEBURST
int us1singleburstline=400,us2singleburstline=400,us3singleburstline=400,us4singleburstline=400;
//MULTIBURST
int us1multiburstline=400,us2multiburstline=400,us3multiburstline=400,us4multiburstline=400;
//COLDPHACO
int us1coldphacoline=40,us2coldphacoline=40,us3coldphacoline=40,us4coldphacoline=40;
int us1coldphaco1line=15,us2coldphaco1line=15,us3coldphaco1line=15,us4coldphaco1line=15;
int currentTab=0;
QMessageBox *message;
...
bool poweronoff1;
bool pinchvalve2Flag;
QTimer *pinchvalve2Timer;

// ── EPT / USD tracking ──────────────────────────────────────────
    bool    m_phacoFiring;          // true while phaco energy is ON
    QElapsedTimer m_phacoSegTimer;  // times the CURRENT continuous phaco burst
    qint64  m_eptTotalMs;           // accumulated EPT in milliseconds
    double  m_usdTotal;             // accumulated USD  in %·seconds
    float   m_currentPowerPct;      // power fraction [0.0 – 1.0] updated each fire
    void    startPhacoTracking(float powerPct);   // call before every phaco_on()
    void    stopPhacoTracking();                   // call after  every phaco_off()
    void    resetEptUsd();                         // call to reset for new case
